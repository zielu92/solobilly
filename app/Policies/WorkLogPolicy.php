...
class WorkLogPolicy
{
    ...
    {
        return $user->can('workLogs.update');
    }
    ...
    {
        return $user->can('workLogs.delete');
    }
    ...
    {
        return $user->can('workLogs.restore');
    }
    ...
    {
        return $user->can('workLogs.forceDelete');
    }
}
